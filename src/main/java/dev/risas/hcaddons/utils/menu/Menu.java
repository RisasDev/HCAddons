package dev.risas.hcaddons.utils.menu;
...
public abstract class Menu {
    ...
    public static Map<String, dev.risas.hcaddons.utils.menu.Menu> currentlyOpenedMenus = new HashMap<>();
    ...
    public void openMenu(final Player player) {
        ...
        dev.risas.hcaddons.utils.menu.Menu previousMenu = dev.risas.hcaddons.utils.menu.Menu.currentlyOpenedMenus.get(player.getName());
        ...
        if (autoUpdate && task == null) {
            task = HCAddons.get().getServer().getScheduler().runTaskTimer(HCAddons.get(), () -> this.openMenu(player), 0, 20L);
        }
    }
